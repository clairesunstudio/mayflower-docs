...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| ![](../../.gitbook/assets/h1-2%20%281%29.png) | H1 | &gt;= 1200 | 16px | 3.5rem | 56px | 1.07 | 59.92px |
|  |  | 780 ~ 1200 | 16px | 3.25rem | 52px | 1.07 | 55.64px |
|  |  | 620 ~ 780 | 16px | 3rem | 48px | 1.07 | 51.36px |
|  |  | &lt;= 620 | 14.5px | 3rem | 43.5px | 1.07 | 46.545px |
| ![](../../.gitbook/assets/h1-2-4.png) | H2 | Above 620px | 16px | 2.5rem | 40px | 1.2 | 48px |
|  |  | Below 620px | 14.5px | 2.5rem | 36.25px | 1.2 | 43.5px |
| ![](../../.gitbook/assets/h1-2-2-1-2.png) | H3 | Above 620px | 16px | 2.125rem | 34px | 1.2 | 40.8px |
...
| ![](../../.gitbook/assets/h1-2-2-2-2-3.png) | H5 | Above 620px | 16px | 1.625rem | 26px | 1.3 | 33.8px |
...
| **Visual** | **Name** | **Description & Usage** |
| :--- | :--- | :--- |
| ![](../../.gitbook/assets/screen-shot-2018-08-09-at-4.34.45-pm%20%284%29.png) | Component Heading | Should be used to to separate content within a big section. If used under Colored Heading, should use a lower heading level than the colored heading. |
| ![](../../.gitbook/assets/screen-shot-2018-08-09-at-4.29.08-pm-4.png) | Component Heading \(Highlight\) |  |

#### Sidebar Heading Variations

| **Visual** | **Name** | **Description & Usage** |
| :--- | :--- | :--- |
| ![](../../.gitbook/assets/sidebarheading-1-1.png) | Sidebar Heading | Should be used as a heading of a list either full width or in a 50/50 split the main content well. |
