...
| ![](../../.gitbook/assets/textarea-as-disabled%20%282%29.png) | Disabled | In a disabled state, a user cannot input anything into text area. Use a disabled state if an action needs to be taken before a user can use the input. |
