...
| :--- | :--- | :--- |
| ![](../../.gitbook/assets/link-1.png) | [Link](links.md#link) | Use when you are linking just a few words of text or when you are doing inline links. |
...
| ![](../../.gitbook/assets/primarybutton%20%284%29.png) | Link Button | Refer to [Link Button](buttons.md#link-button) in the [Buttons](buttons.md) section. |
