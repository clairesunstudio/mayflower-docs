...
| ![](../../.gitbook/assets/outlinebutton-2.png)![Example of Secondary Button](../../.gitbook/assets/screen-shot-2018-08-09-at-2.39.01-pm.png) | Secondary Button | For the secondary action on a page. Inverting the primary button to provide a less prominent action on a page, e.g. the Back button. |
