...
{% tabs %}
{% tab title="Visual" %}
![Example of Primary Button](../../.gitbook/assets/primary-button-3%20%287%29.gif)
{% endtab %}
...
{% tabs %}
{% tab title="Visual" %}
![Example Link Button](../../.gitbook/assets/primary-button-3%20%285%29.gif)
{% endtab %}
